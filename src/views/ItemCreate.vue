...
export default {
  ...
  methods: {
    addAttribute() {
      if (this.selectedAttribute) {
        this.productVariationAttributes.push({ name: this.selectedAttribute, values: '' });
  ...
  if (confirm('Are you sure you want to delete this pack size?')) {
    ...
    try {
        ...
        const response = await axios.post(`${apiBase}/pharmacy-app/api/product-store`, payload, config);
  ...
  data() {
    ...
    recorder_level: "1",
      ...
      productVariations: [
        { name: "Pogo Syp. (Syr)", attributes: "jahds", item_number: "12345", is_ecommerce_item: "1", variation_id: "12" },
        { name: "Pogo Syp. (Syr)", attributes: "jahds", item_number: "12345", is_ecommerce_item: "1", variation_id: "12" }
      ],
      selectedAttribute: '',
        ...
        <tbody>
          <tr v-for="(attribute, index) in productVariationAttributes" :key="index">
            ...
            <td class="border border-gray-300 p-2 text-center">
              <button @click="deleteAttribute(index)" class="text-red-500">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
      ...
      <table class="w-full border-collapse">
        ...
        <tbody>
          <tr v-for="(variation, index) in productVariations" :key="index">
            ...
            <td class="border border-gray-300 p-2 text-center">
              <button @click="deleteVariation(index)" class="text-red-500">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
  ...
  <div class="bg-white p-5 rounded-lg shadow">
    ...
    <form>
      ...
      <div class="grid grid-cols-2 gap-4 mb-4">
        ...
        <div class="flex items-center gap-2">
          <input type="checkbox" v-model="product_prices.allow_price_override" />
        ...
        <div class="flex items-center gap-2">
          <input type="checkbox" v-model="product_prices.only_allow_whole_numbers" />
  ...
  <form>
    ...
    <div class="mb-4">
      ...
      <div class="flex space-x-4">
        <div v-for="(image, index) in images" :key="index" class="w-16 h-16 border border-gray-400 flex items-center justify-center">
