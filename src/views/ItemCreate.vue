  ...
  setup() {
    ...
    const itemVariations = async () => {
      try {
        ...
        console.log("Product Variation Attributes:", productVariationAttributes.value);
        ...
        const payload = {
          ...
          product_variation_attributes: productVariationAttributes.value.map(attr => ({
            ...attr,
            product_id: globalProductId.value,
          })),
    ...
    const itemPrice = async () => {
      try {
        ...
        const payload = {
          product_prices: { ...product_prices, product_id: globalProductId.value }, product_id: globalProductId.value,
        };
    ...
    const itemInventory = async () => {
      try {
        ...
        const payload = {
          product_inventories: { ...product_inventories, product_id: globalProductId.value }, product_id: globalProductId.value,
        };
    ...
    const itemLocation = async () => {
      try {
        ...
        const payload = {
          product_locations: { ...product_locations, product_id: globalProductId.value },
          product_id: globalProductId.value,
        };
    ...
    const onFileChange = (event) => {
      ...
      for (let i = 0; i < files.length; i++) {
        ...
        reader.onload = (e) => {
          images.push({ src: e.target.result, product_id: globalProductId.value });
        };
  ...
  <MainLayout>
    <div class="space-y-5 p-5">
      ...
      <template v-if="activeTab === 'itemInfo'">
        <div>
          <h2 class="text-lg font-semibold mb-4">
            <span class="text-blue-500">Item Information (Fields in red are mandatory)</span>
          </h2>
          ...
          <div class="space-y-4">
            ...
            <div class="flex flex-col">
              <label for="category_id" class="text-sm font-semibold mb-1">Select Category</label>
              <select
                id="category_id"
            ...
            <!-- Supplier Select -->
            <div class="flex flex-col">
              <label for="supplier_id" class="text-sm font-semibold mb-1">Select Supplier</label>
              <select
                id="supplier_id"
      ...
      <div class="bg-white p-5 mt-4 rounded-lg shadow">
        ...
        <div v-for="(attribute, index) in productVariationAttributes" :key="index">
          ...
          />
          <label class="block text-gray-700 font-semibold mb-2">Values</label>
          <input
            type="number"
