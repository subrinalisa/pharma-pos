  ...
  <MainLayout>
    <div class="flex justify-between mb-4">
      ...
      <router-link :to="{ name: 'item-add' }">
        <button
          @click="addItem"
          class="flex items-center px-4 py-2 bg-[#000180] text-white rounded hover:bg-blue-600"
        >
    ...
    <div class="overflow-x-auto">
      <table class="min-w-full bg-white">
        <thead>
          <tr>
            <th
              class="py-2 px-4 bg-gray-200 text-gray-600 border-b border-gray-200 text-left text-sm uppercase font-normal"
            >
              Actions
            </th>
            <th
            ...
            <td class="py-2 px-4 border-b border-gray-200">
              <div class="flex space-x-2">
                <button
                  ...
                  class="px-2 py-1 bg-[#000180] text-white rounded hover:bg-yellow-600"
                >
                  <EditOutlined />
                </button>
                <button
